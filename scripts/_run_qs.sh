...
export QS_SERVER_HOST=$(hostname)  # or host (that passes $(hostname) test below)
export QS_UPDATE_PLANS_DEVICES=ENVIRONMENT_OPEN
export QS_USER_GROUP_PERMISSIONS_FILE="/Users/ecodrea/test_bs_id_2/src/instrument/configs/user_group_permissions.yaml" #TODO: De-hardcode
export QS_USER_GROUP_PERMISSIONS_RELOAD=ON_STARTUP
export STARTUP_DIR="/Users/ecodrea/test_bs_id_2/src/instrument/qs_folder"
